...
class CategoriesTopNftDropDownButton extends StatefulWidget {
  ...
  @override
  State<CategoriesTopNftDropDownButton> createState() =>
      _CategoriesTopNftDropDownButtonState();
}

class _CategoriesTopNftDropDownButtonState
    extends State<CategoriesTopNftDropDownButton> {
