...
import '../repository/interface_top_nfts_info_repository.dart';
import '../repository/top_nfts_info_http.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        Provider<InterfaceTopNftsInfoRepository>(
            create: (_) => TopNftsInfoHttp())
      ],
      child: MaterialApp(
